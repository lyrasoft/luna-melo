import { render, h, defineComponent, mergeModels, useSlots, useAttrs, useModel, ref, useTemplateRef, computed, toRef, watch, nextTick, onMounted, onBeforeUnmount, createElementBlock, openBlock, Fragment, createElementVNode, renderSlot, createVNode, unref, normalizeProps, guardReactiveProps, withCtx, createBlock, createCommentVNode, Transition, mergeProps, withDirectives, normalizeStyle, normalizeClass, createTextVNode, toDisplayString, vShow, shallowRef, getCurrentScope, onScopeDispose, shallowReadonly, toValue as toValue$1, readonly, inject, toRefs, withModifiers, TransitionGroup, renderList, defineAsyncComponent, resolveDynamicComponent, provide, createApp } from "vue";
import { uniqueItemList, uniqueItem } from "@lyrasoft/ts-toolkit/vue";
import { useHttpClient, sleep, deleteConfirm, slideDown, slideUp, useUnicorn, injectCssToDocument } from "@windwalker-io/unicorn-next";
import { u as useDefaults, a as useId, b as useToNumber, c as createSharedComposable, o as onClickOutside, _ as _sfc_main$6, d as useMouse$1, e as defaultsKey, r as rtlRegistryKey, s as showHideRegistryKey, f as breadcrumbGlobalIndexKey, g as breadcrumbRegistryKey, m as modalManagerKey, h as orchestratorRegistryKey, i as _export_sfc } from "./_plugin-vue_export-helper.js";
import { u as useShowHide, g as getElement, _ as _newOrchestratorRegistry, a as _sfc_main$8 } from "./index-CyEArZ56.js";
import { c as createGlobalState, u as useDebounceFn, _ as _sfc_main$7, a as _sfc_main$9 } from "./index.js";
...
const _hoisted_1$4 = { class: "c-chapter-item-outside" };
...
const TypeSelector = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-8f232b9a"], ["__file", "TypeSelector.vue"]]);
...
const SegmentEditorApp = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-74c7444f"], ["__file", "SegmentEditorApp.vue"]]);
