import { defineComponent, useSlots, computed, createBlock, openBlock, resolveDynamicComponent, unref, normalizeClass, withCtx, createElementBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, readonly, toRef, toValue, useAttrs, inject, mergeProps, getCurrentInstance, mergeModels, useTemplateRef, useModel, Fragment, createVNode, effectScope, watch, customRef, getCurrentScope, onScopeDispose, ref } from "vue";
import { u as useDefaults, c as useColorVariantClasses, k as isEmptySlot, K as collapseInjectionKey, L as navbarInjectionKey, M as toPascalCase, E as onKeyStroke } from "./_plugin-vue_export-helper.js";
...
const useSegmentController = /* @__PURE__ */ createGlobalState(() => {
  ...
  const reorder = /* @__PURE__ */ useDebounceFn(async (segments) => {
    return run(async () => {
      const orders = {};
...
export {
  ...
  _sfc_main as a,
  useDebounceFn as b,
  BvTriggerableEvent as c,
  createGlobalState as d,
  computedWithControl as e,
  createEventHook as f,
  hasOwn as h,
  isClient as i,
