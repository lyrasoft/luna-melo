import { defineComponent, useSlots, computed, openBlock, createBlock, resolveDynamicComponent, unref, normalizeClass, withCtx, createElementBlock, renderSlot, createTextVNode, toDisplayString, createCommentVNode, readonly, toRef, toValue as toValue$1, useAttrs, inject, mergeProps, getCurrentInstance, useTemplateRef, useModel, Fragment, createVNode, mergeModels, ref, watch, onMounted, nextTick, onBeforeUnmount, onUnmounted, render, h, createElementVNode, normalizeProps, guardReactiveProps, Transition, withDirectives, normalizeStyle, vShow, shallowRef, getCurrentScope, onScopeDispose, shallowReadonly } from "vue";
import { u as useDefaults, c as useColorVariantClasses, x as isEmptySlot, F as collapseInjectionKey, G as navbarInjectionKey, H as toPascalCase, w as onKeyStroke, I as useEventListener, s as showHideRegistryKey, J as useThrottleFn, g as useId, K as onClickOutside, _ as _sfc_main$4, e as useToNumber, q as createSharedComposable, L as useMouse$1, d as defaultsKey } from "./index-BSgsF2PB.js";
const _hoisted_1$1 = {
  key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), {
        ...
        default: withCtx(() => [
          unref(props).label || hasLabelSlot.value ? (openBlock(), createElementBlock("span", _hoisted_1$1, [
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const computedTag = computed(() => isBLink.value ? _sfc_main$2 : props.href ? "a" : props.tag);
    const clicked = (e) => {
      if (props.disabled) {
        e.preventDefault();
        e.stopPropagation();
