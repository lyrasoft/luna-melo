(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      elementStyle.appendChild(document.createTextNode(`.c-file-uploader__card-body[data-v-1bc1eb38] {
  height: 200px;
  position: relative;
}
.c-file-uploader__inner[data-v-1bc1eb38] {
  margin: 0;
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
}.l-section-video-edit .rwd-video[data-v-e26fcac5] {
  position: relative;
...
.l-section-video-edit .rwd-video > iframe[data-v-e26fcac5],
.l-section-video-edit .rwd-video > embed[data-v-e26fcac5],
.l-section-video-edit .rwd-video > object[data-v-e26fcac5] {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.l-section-video-edit #input-section-video[data-v-e26fcac5] {
  border-radius: 0.25rem 0 0 0.25rem;
}.c-question-button[data-v-5800af3a] {
  transition: all 0.3s;
}
.c-question-button[data-v-5800af3a]:hover {
  background-color: var(--bs-primary-bg-subtle);
}.c-section-button[data-v-a6c52412] {
  transition: all 0.3s;
}
.c-section-button[data-v-a6c52412]:hover {
  background-color: var(--bs-primary-bg-subtle);
...
import { delegate, useHttpClient, route, useUnicorn, simpleAlert, useMacro } from "@windwalker-io/unicorn-next";
function useLessonCartButtons(selector) {
  listen(selector);
  return {
    off,
    buy,
...
async function buttonClicked(e) {
  ...
  try {
    ...
    if (isAxiosError(e2)) {
      simpleAlert(e2.message, "", "warning");
    }
    return;
  }
}
...
async function buy(id, data) {
  await sendAddAction(id, data);
  toCartPage();
}
async function sendAddAction(id, data) {
  if (!id) {
...
function updateCartButtons(items, options = {}) {
  ...
  for (const $cartButton of $cartButtons) {
    const $cartQuantity = $cartButton.querySelector(
...
const sectionEditComponents = {
  ...
  homework: () => import("./chunks/SectionHomeworkEdit.js"),
  quiz: () => import("./chunks/SectionQuizEdit.js")
};
function useSectionEditComponents(id, component) {
  if (typeof id === "object") {
