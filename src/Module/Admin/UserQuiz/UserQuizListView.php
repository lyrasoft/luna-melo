...
/**
 * The UserQuizListView class.
 */
#[ViewModel(
    layout: [
        'default' => 'user-quiz-list',
        'modal' => 'user-quiz-modal',
    ],
    js: 'user-quiz-list.js'
)]
class UserQuizListView implements ViewModelInterface, FilterAwareViewModelInterface
{
    use TranslatorTrait;
    ...
    {
        $htmlFrame->setTitle(
            $this->trans('unicorn.title.grid', title: '考試報表')
        );
    }
}
